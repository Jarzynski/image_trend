...
| --- | --- | --- | --- | --- |
| 2026-05-08 | `v0.1.1` | 上传 CNN 训练脚本详细说明文档 | 将 `05_train_cnn2d.md` 纳入 Git 版本管理，便于同步查看 05 脚本的逐函数、全流程和变量解释 | 按持有期修正回测年化因子；实现重叠持仓组合；增加训练日志与参数配置文件；补充单元测试和数据 schema 检查；加入混合精度和多卡训练支持 |
